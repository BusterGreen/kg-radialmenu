        ...
        items = {
            {
                ...
                icon = 'address-book',
                type = 'client',
                event = 'kg-phone:client:GiveContactDetails',
                shouldClose = true
            }, {
            id = 'getintrunk',
            title = 'Get In Trunk',
            ...
            icon = 'cannabis',
            type = 'client',
            event = 'kg-drugs:client:cornerselling',
            shouldClose = true
        }, {
            id = 'togglehotdogsell',
        ...
        items = {
            {
                ...
                items = {
                    ...
                    icon = 'door-closed',
                    type = 'client',
                    event = 'kg-houses:client:toggleDoorlock',
                    shouldClose = true
                }, {
                    id = 'decoratehouse',
                    ...
                    icon = 'box',
                    type = 'client',
                    event = 'kg-houses:client:decorate',
                    shouldClose = true
                }, {
                    id = 'houseLocations',
                    ...
                    items = {
                        {
                            ...
                            icon = 'box-open',
                            type = 'client',
                            event = 'kg-houses:client:setLocation',
                            shouldClose = true
                        }, {
                        id = 'setoutift',
                        title = 'Set Wardrobe',
            ...
            items = {
                {
                    ...
                    icon = 'user',
                    type = 'client',
                    event = 'kg-radialmenu:ToggleClothing',
                    shouldClose = true
                }, {
                id = 'Ear',
                title = 'Ear Piece',
                icon = 'ear-deaf',
                type = 'client',
                event = 'kg-radialmenu:ToggleProps',
                shouldClose = true
            }, {
                id = 'Neck',
                title = 'Neck',
    ...
    items = {
        {
            ...
            icon = 'car-side',
            type = 'client',
            event = 'kg-radialmenu:client:openDoor',
            shouldClose = false
        }, {
        id = 'door4',
        title = 'Hood',
    ...
    items = {
        {
            ...
            icon = 'box-open',
            type = 'client',
            event = 'kg-radialmenu:client:setExtra',
            shouldClose = false
        }, {
        id = 'extra2',
        title = 'Extra 2',
...
Config.JobInteractions = {
        ...
        items = {
            {
                ...
                icon = 'plus',
                type = 'client',
                event = 'kg-radialmenu:client:TakeStretcher',
                shouldClose = false
            }, {
            id = 'despawnstretcher',
            ...
            icon = 'minus',
            type = 'client',
            event = 'kg-radialmenu:client:RemoveStretcher',
            shouldClose = false
        }
        }
    }
    ...
    ['taxi'] = {
        {
            ...
            icon = 'eye-slash',
            type = 'client',
            event = 'kg-taxi:client:toggleMeter',
            shouldClose = false
        }, {
        id = 'togglemouse',
        ...
        type = 'client',
        event = 'kg-taxi:client:enableMeter',
        shouldClose = true
    }, {
        id = 'npc_mission',
        title = 'NPC Mission',
        icon = 'taxi',
        type = 'client',
        event = 'kg-taxi:client:DoTaxiNpc',
        shouldClose = true
    }
    },
    ['tow'] = {
        ...
        icon = 'truck-pickup',
        type = 'client',
        event = 'kg-tow:client:TowVehicle',
        shouldClose = true
    }
    },
    ['mechanic'] = {
    ...
    ['police'] = {
        ...
        icon = 'circle-info',
        type = 'client',
        event = 'kg-tunerchip:client:TuneStatus',
        shouldClose = true
    }, {
        id = 'resethouse',
