...
RegisterNetEvent('kg-radialmenu:ResetClothing', ResetClothing)
...
RegisterNetEvent('kg-radialmenu:ToggleClothing', ToggleClothing)
...
RegisterNetEvent('kg-radialmenu:ToggleProps', ToggleProps)
...
function Notify(message, color) -- However you want your notifications to be shown, you can switch it up here.
	KGCore.Functions.Notify(message, color)
end
